			...
			<div class="col_8 first" >
				      ...
				      <div class="slideshow-container">
					 	<div class="slideshow-inner">
              						<div class="mySlides fade">
					            		...
					            		<div class="imgbox"><img class="center-fit" src="Images/Free_Trading.png" alt="Suited man watering a money tree"></div>
								</a>
              						</div>
							<div class="mySlides fade">
				...
				<div style="border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: #FF9300;">
					...
					<a href="https://www.evolving.money/EMoney/blockchain-in-renewable-energy.php">
						<div class="col_int_6" style="border-radius: 15px 15px 0px 0px;">
				...
				<div>
					<div class="col_int_12">
						<h1><strong>Saving Money:</strong></h1>
					</div>
