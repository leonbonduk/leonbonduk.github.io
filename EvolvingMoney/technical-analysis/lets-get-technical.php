...
<p>Things will start simply with some <strong>basic models using moving averages and momentum</strong> to make trading decisions, then we will start to look at some more advanced techniques, where we get the computer to make the model for us using <strong>different ML techniques</strong>.</p>
