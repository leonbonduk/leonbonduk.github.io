...
<li class="three_line cd-features-subheading">Application process</li>
...
<div class="top-info">
<div class="check"></div>
<img class="col-fit-img" src="https://evolving.money/Images/Cashplus_flexi_logo_EM.png" alt="product image">
<h3 class="comp_title">Cashplus Flexi</h3>
</div> <!-- .top-info -->
<ul class="cd-features-list">
<li class="one_line">2005</li>
<li class="one_line">UK</li>
