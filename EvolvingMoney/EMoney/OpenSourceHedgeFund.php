...
<div class="row">
	...
	<div class="col_8 first" style="background-color:#fff">	
		...
		<h2> <strong>NumerAi</strong> the open-source hedge fund </h2>
                ...
                <p> In quant hedge funds algorithms generate models for technical analysis of stock prices and these models. Quants tend to do the larger proportion of the trading rather than a human trader.
                    These algorithms are kept closely guarded, and are not something a normal hedge fund would share, but in the case of NumerAI that it is precisely these tools
                    that are shared. <p>		 
