...
<div class="row">
	...
	<div class="col_8 first" style="background-color:#fff">	
		...
		<h2> <strong>NumerAi</strong> the open-source hedge fund </h2>
                ...
                <p> In hedge funds algorithms generate models for technical analysis of stock prices. Algorithms tend to do the larger proportion of the trading rather than a human trader.
