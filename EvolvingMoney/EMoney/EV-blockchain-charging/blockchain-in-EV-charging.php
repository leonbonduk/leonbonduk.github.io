...
<head>		
	<meta charset="UTF-8">
       	<title>Can blockchain ease range anxiety in electric vehicles with smart charging payments?</title>	
...
<div class="row">
	...
	<div class="col_8 first" style="background-color:#fff">	
		...
		<p>There has been interesting research in the blockchain use case by the <strong>University of Waterloo</strong>. [Christian Gorenflo Waterloo’s David R Cheriton School of Computer Science]</p>

		<p>There are also now discussion groups working in this topic, in particular <a class="link" href="https://www.eurelectric.org/news/eurelectric-launches-expert-discussion-platform-on-blockchain">EURELECTRIC</strong></a>, where you can find a wealth of information about the topic.</p>
	</div>
